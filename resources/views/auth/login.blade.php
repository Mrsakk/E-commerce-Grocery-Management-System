...
<head>
    ...
    <meta name="description" content="Sign in to FreshMart — Cambodia's premium online grocery store for fresh vegetables, fruits, and meats.">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-control-custom:focus + .input-icon-after,
        .input-wrap:focus-within .input-icon { color: var(--green-500); }

        .invalid-msg { color: #ef4444; font-size: 0.78rem; margin-top: 5px; }

        .row-between { display: flex; justify-content: space-between; align-items: center; margin-bottom: 7px; }
        .forgot-link { font-size: 0.8rem; color: var(--green-600); text-decoration: none; font-weight: 500; }
        ...
        .remember-row input[type="checkbox"] { accent-color: var(--green-600); width: 15px; height: 15px; cursor: pointer; }
        .remember-row label { font-size: 0.83rem; color: #6b7280; cursor: pointer; }
        ...
        .divider-or { display: flex; align-items: center; gap: 12px; color: #d1d5db; font-size: 0.78rem; margin: 18px 0; font-weight: 500; }
        ...
        .demo-label { text-align: center; font-size: 0.75rem; color: #9ca3af; font-weight: 500; margin-bottom: 8px; letter-spacing: 0.3px; text-transform: uppercase; }
        ...
        .demo-btn:hover { border-color: var(--green-500); background: var(--green-100); color: var(--green-700); transform: translateY(-1px); }

        .register-link { text-align: center; margin-top: 20px; font-size: 0.84rem; color: #6b7280; }
        .register-link a { color: var(--green-600); font-weight: 600; text-decoration: none; }
        ...
        @media (max-width: 820px) {
            .auth-wrapper { width: 100%; min-height: 100dvh; border-radius: 0; flex-direction: column; }
            .hero-panel { display: none; }
            .form-panel { width: 100%; flex: 1; padding: 40px 28px; }
    ...
    <div class="auth-wrapper">
        ...
        <div class="hero-panel">
            ...
            <div class="hero-main">
                ...
                <p>Shop premium vegetables, fruits, and meats from the finest local farms in Cambodia — all delivered within 2 hours to your door.</p>
                <div class="feature-chips">
                    <div class="feature-chip">
                        <div class="chip-icon"><i class="bi bi-box-seam-fill text-white"></i></div>
                        500+ Farm-Fresh Products
                    </div>
                    <div class="feature-chip">
                        <div class="chip-icon"><i class="bi bi-lightning-charge-fill text-white"></i></div>
                        2-Hour Delivery in Phnom Penh
                    </div>
                    <div class="feature-chip">
                        <div class="chip-icon"><i class="bi bi-shield-check-fill text-white"></i></div>
                        100% Secure Checkout
                    </div>
                    <div class="feature-chip">
                        <div class="chip-icon"><i class="bi bi-truck-front-fill text-white"></i></div>
